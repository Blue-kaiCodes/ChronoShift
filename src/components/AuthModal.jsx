...
export default function AuthModal({ onAuthSuccess, onBackToLanding }) {
  ...
  return (
    <div className="w-full min-h-screen bg-zinc-50 dark:bg-[#070708] flex flex-col justify-center items-center p-4 selection:bg-zinc-200 dark:selection:bg-zinc-800">
      ...
      <button 
        ...
        className="mb-8 flex items-center gap-2 text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-200 transition-colors text-xs font-medium"
      >
      ...
      >
        ...
        {/* SINGLE SECURE AUTHENTICATION ACTION */}
        <button
        ...
        <div className="mt-8 text-center">
          <p className="text-[10px] leading-normal text-zinc-400 font-medium">
            We only access your email address and profile picture to set up your workspace profile. We never request persistent write permissions to external calendars.
          </p>
        </div>
